    ...
    def post(self, request):
        ...
        try:
            if data.get('guardian_status'):
                ...
                alumni_status = True if data.get('alumni_status') else False
                ...
                log_file('Adding Student with new guardian registration')
                student_index_number = data['student_index_number']
                student_full_name = data['student_full_name']
                student_name_with_initials = data['student_name_with_initials']
                student_date_of_birth = data['student_date_of_birth']
                ...
                guardian_name_with_initials = data['guardian_name_with_initials']
                guardian_date_of_birth = data['guardian_date_of_birth']
                guardian_gender = data['guardian_gender']
                guardian_nic = data['guardian_nic']
                ...
                guardian_instance = GuardianInfo(
                    ...
                    name_with_initials=guardian_name_with_initials,
